...
namespace libavcodec
{
    ...
    public unsafe partial struct AVFrame
    {
        ...
        /// 
        /// Note: Both data and extended_data will always be set by
        /// get_buffer(),
        ...
        /// This isn't used by libavcodec unless the default
        /// get/release_buffer() is used.
        /// - encoding:
        /// - decoding:
        /// </summary>
        [FieldOffset(92)]
        ...
        /// variable, that is 1->top field, 2->bottom field, 3->frame/both
        /// fields.
    ...
    public unsafe partial struct AVCodecContext
    {
        ...
        /// larger
        /// than extradata_size to avoid prolems if it is read with the
        /// bitstream reader.
        ...
        /// samples relative to the input to the encoder. Note that this field
        /// is
        /// purely informational and does not directly affect the pts output by
        /// the encoder, which should always be based on the actual
        /// presentation
    ...
    public unsafe partial struct AVSubtitleRect
    {
        ...
        /// A forced subtitle should be displayed even when subtitles are
        /// hidden.
        /// </summary>
        [FieldOffset(96)]
        public int forced;
    ...
    public unsafe partial class libavcodec
    {
        ...
        [DllImport("avcodec-if-54.dll", CallingConvention = global::System.Runtime.InteropServices.CallingConvention.Cdecl,
        ...
        internal static extern AVCodecContext* avcodec_alloc_context2(AVMediaType _0);
        ...
        internal static extern void avcodec_get_context_defaults(AVCodecContext* s);
        ...
        internal static extern void avcodec_get_context_defaults2(AVCodecContext* s, AVMediaType _0);
        ...
        internal static extern int avcodec_open(AVCodecContext* avctx, AVCodec* codec);
        ...
        internal static extern int avpicture_alloc(AVPicture* picture, PixelFormat pix_fmt, int width, int height);
        ...
        internal static extern int avpicture_fill(AVPicture* picture, byte* ptr, PixelFormat pix_fmt, int width, int height);
        ...
        internal static extern int avpicture_layout(AVPicture* src, PixelFormat pix_fmt, int width, int height, byte* dest, int dest_size);
        ...
        internal static extern int avpicture_get_size(PixelFormat pix_fmt, int width, int height);
        ...
        internal static extern int avpicture_deinterlace(AVPicture* dst, AVPicture* src, PixelFormat pix_fmt, int width, int height);
        ...
        internal static extern void av_picture_copy(AVPicture* dst, AVPicture* src, PixelFormat pix_fmt, int width, int height);
        ...
        internal static extern int av_picture_crop(AVPicture* dst, AVPicture* src, PixelFormat pix_fmt, int top_band, int left_band);
        ...
        internal static extern int av_picture_pad(AVPicture* dst, AVPicture* src, int height, int width, PixelFormat pix_fmt, int padtop, int padbottom, int padleft, int padright, int* color);
        ...
        internal static extern void avcodec_get_chroma_sub_sample(PixelFormat pix_fmt, int* h_shift, int* v_shift);
        ...
        internal static extern uint avcodec_pix_fmt_to_codec_tag(PixelFormat pix_fmt);
        ...
        internal static extern int avcodec_get_pix_fmt_loss(PixelFormat dst_pix_fmt, PixelFormat src_pix_fmt, int has_alpha);
        ...
        internal static extern PixelFormat avcodec_find_best_pix_fmt(long pix_fmt_mask, PixelFormat src_pix_fmt, int has_alpha, int* loss_ptr);
        ...
        internal static extern PixelFormat avcodec_find_best_pix_fmt_of_list(PixelFormat pix_fmt_list, PixelFormat src_pix_fmt, int has_alpha, int* loss_ptr);
        ...
        internal static extern PixelFormat avcodec_find_best_pix_fmt_of_2(PixelFormat dst_pix_fmt1, PixelFormat dst_pix_fmt2, PixelFormat src_pix_fmt, int has_alpha, int* loss_ptr);

        [SuppressUnmanagedCodeSecurity]
        [DllImport("avcodec-if-54.dll", CallingConvention = global::System.Runtime.InteropServices.CallingConvention.Cdecl,
            EntryPoint="avcodec_find_best_pix_fmt2")]
        internal static extern PixelFormat avcodec_find_best_pix_fmt2(PixelFormat dst_pix_fmt1, PixelFormat dst_pix_fmt2, PixelFormat src_pix_fmt, int has_alpha, int* loss_ptr);

        [SuppressUnmanagedCodeSecurity]
        [DllImport("avcodec-if-54.dll", CallingConvention = global::System.Runtime.InteropServices.CallingConvention.Cdecl,
            EntryPoint="avcodec_default_get_format")]
        internal static extern PixelFormat avcodec_default_get_format(AVCodecContext* s, PixelFormat fmt);
        ...
        internal static extern void avcodec_default_free_buffers(AVCodecContext* s);
