...
namespace FFmpeg
{
    public unsafe static partial class libavformat
    {
        ...
        public const int AVFMT_TS_NONSTRICT = 8020000;
        ...
        public unsafe partial struct AVStream
        {
            ...
            public unsafe partial struct AVStream_anon
            {
                ...
                public libavutil.ArrayWrapper_Double____2 duration_error;
        ...
        public static extern int av_interleave_packet_per_dts(libavformat.AVFormatContext* s, libavcodec.AVPacket* _out, libavcodec.AVPacket* pkt, int flush);
        ...
        public static extern libavutil.AVRational av_guess_sample_aspect_ratio(libavformat.AVFormatContext* format, libavformat.AVStream* stream, libavcodec.AVFrame* frame);
        ...
        public static extern void avformat_queue_attached_pictures(libavformat.AVFormatContext* s);
    }
}
