...
namespace libavutil
{
    public unsafe partial class libavutil
    {
        ...
        internal static extern int av_image_fill_linesizes(int* linesizes, AVPixelFormat pix_fmt, int width);
        ...
        internal static extern int av_image_fill_pointers(byte* data, AVPixelFormat pix_fmt, int height, byte* ptr, int* linesizes);
        ...
        internal static extern int av_image_alloc(byte* pointers, int* linesizes, int w, int h, AVPixelFormat pix_fmt, int align);
        ...
        internal static extern void av_image_copy(byte* dst_data, int* dst_linesizes, byte* src_data, int* src_linesizes, AVPixelFormat pix_fmt, int width, int height);
        ...
        internal static extern int av_image_fill_arrays(byte* dst_data, int* dst_linesize, byte* src, AVPixelFormat pix_fmt, int width, int height, int align);
        ...
        internal static extern int av_image_copy_to_buffer(byte* dst, int dst_size, byte* src_data, int* src_linesize, AVPixelFormat pix_fmt, int width, int height, int align);
        ...
        internal static extern int avpriv_set_systematic_pal2(uint* pal, AVPixelFormat pix_fmt);
    }
}
