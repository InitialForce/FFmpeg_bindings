...
namespace FFmpeg
{
    ...
    public unsafe static partial class libavformat
    {
        ...
        /// 
        /// @param s media file handle
        /// @param pkt The packet containing the data to be written. Note that
        /// unlike
        ...
        /// correct values.
        /// 
        /// @return 0 on success, a negative AVERROR on error. Libavformat will
        /// always
        ...
        /// 
        /// @return  >=0 if an uncoded frame can be written to that muxer and
        /// stream,
        /// 0 if not
        /// </summary>
        [SuppressUnmanagedCodeSecurity]
        ...
        /// <summary>
        /// @return the table mapping MOV FourCCs for video to libavcodec
        /// AVCodecID.
        /// </summary>
        [SuppressUnmanagedCodeSecurity]
        [DllImport(AVFORMAT_DLL_NAME, CallingConvention = global::System.Runtime.InteropServices.CallingConvention.Cdecl,
