...
namespace FFmpeg
{
    public unsafe static partial class libavcodec
    {
        ...
        public const sbyte CODEC_FLAG_UNALIGNED = 0x1;

        public const sbyte CODEC_FLAG_QSCALE = 0x2;

        public const sbyte CODEC_FLAG_4MV = 0x4;

        public const sbyte CODEC_FLAG_OUTPUT_CORRUPT = 0x8;

        public const sbyte CODEC_FLAG_QPEL = 0x10;
        ...
        public const short CODEC_FLAG_PASS1 = 0x200;

        public const short CODEC_FLAG_PASS2 = 0x400;

        public const short CODEC_FLAG_GRAY = 0x2000;

        public const short CODEC_FLAG_EMU_EDGE = 0x4000;

        public const ushort CODEC_FLAG_PSNR = 0x8000;
        ...
        public const short CODEC_FLAG_LOOP_FILTER = 0x800;

        public const int CODEC_FLAG_INTERLACED_ME = 0x20000000;

        public const uint CODEC_FLAG_CLOSED_GOP = 0x80000000;

        public const sbyte CODEC_FLAG2_FAST = 0x1;

        public const sbyte CODEC_FLAG2_NO_OUTPUT = 0x4;

        public const sbyte CODEC_FLAG2_LOCAL_HEADER = 0x8;

        public const short CODEC_FLAG2_DROP_FRAME_TIMECODE = 0x2000;

        public const int CODEC_FLAG2_IGNORE_CROP = 0x10000;

        public const ushort CODEC_FLAG2_CHUNKS = 0x8000;
        ...
        public const sbyte CODEC_CAP_DRAW_HORIZ_BAND = 0x1;

        public const sbyte CODEC_CAP_DR1 = 0x2;

        public const sbyte CODEC_CAP_TRUNCATED = 0x8;

        public const sbyte CODEC_CAP_HWACCEL = 0x10;

        public const sbyte CODEC_CAP_DELAY = 0x20;

        public const sbyte CODEC_CAP_SMALL_LAST_FRAME = 0x40;

        public const byte CODEC_CAP_HWACCEL_VDPAU = 0x80;

        public const short CODEC_CAP_SUBFRAMES = 0x100;

        public const short CODEC_CAP_EXPERIMENTAL = 0x200;

        public const short CODEC_CAP_CHANNEL_CONF = 0x400;

        public const short CODEC_CAP_NEG_LINESIZES = 0x800;

        public const short CODEC_CAP_FRAME_THREADS = 0x1000;

        public const short CODEC_CAP_SLICE_THREADS = 0x2000;

        public const short CODEC_CAP_PARAM_CHANGE = 0x4000;

        public const ushort CODEC_CAP_AUTO_THREADS = 0x8000;
        ...
        public const sbyte FF_BUFFER_HINTS_VALID = 0x1;

        public const sbyte FF_BUFFER_HINTS_READABLE = 0x2;

        public const sbyte FF_BUFFER_HINTS_PRESERVE = 0x4;

        public const sbyte FF_BUFFER_HINTS_REUSABLE = 0x8;
