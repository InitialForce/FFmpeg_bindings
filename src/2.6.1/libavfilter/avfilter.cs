...
namespace FFmpeg
{
    ...
    {
        public const sbyte AV_PERM_READ = 0x1;

        public const sbyte AV_PERM_WRITE = 0x2;

        public const sbyte AV_PERM_PRESERVE = 0x4;

        public const sbyte AV_PERM_REUSE = 0x8;

        public const sbyte AV_PERM_REUSE2 = 0x10;

        public const sbyte AV_PERM_NEG_LINESIZES = 0x20;

        public const sbyte AV_PERM_ALIGN = 0x40;
