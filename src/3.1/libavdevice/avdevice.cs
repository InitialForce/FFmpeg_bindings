...
namespace FFmpeg
{
    ...
    public unsafe static partial class libavdevice
    {
        ...
        /// </param>
        /// <param name="device_options">
        /// An AVDictionary filled with device-private options. May be NULL.
        /// The same options must be passed later to avformat_write_header() for
        /// output
        /// devices or avformat_open_input() for input devices, or at any other
        /// place
        ...
        [DllImport(AVDEVICE_DLL_NAME, CallingConvention = global::System.Runtime.InteropServices.CallingConvention.Cdecl,
            CharSet = CharSet.Ansi, ExactSpelling = true,
            EntryPoint="avdevice_list_input_sources")]
        public static extern int avdevice_list_input_sources(libavformat.AVInputFormat* device, string device_name, libavutil.AVDictionary* device_options, libavdevice.AVDeviceInfoList** device_list);
        ...
        [DllImport(AVDEVICE_DLL_NAME, CallingConvention = global::System.Runtime.InteropServices.CallingConvention.Cdecl,
            CharSet = CharSet.Ansi, ExactSpelling = true,
            EntryPoint="avdevice_list_output_sinks")]
