...
namespace FFmpeg
{
    ...
    [UnmanagedFunctionPointerAttribute(global::System.Runtime.InteropServices.CallingConvention.Cdecl)]
    public unsafe delegate int AVOpenCallback(libavformat.AVFormatContext* s, libavformat.AVIOContext** pb, string url, int flags, libavformat.AVIOInterruptCB* int_cb, libavutil.AVDictionary** options);
    ...
    public unsafe static partial class libavformat
    {
        ...
        public unsafe partial struct AVProbeData
        {
            ...
            /// <summary>
            /// &lt; Buffer must have AVPROBE_PADDING_SIZE of extra allocated bytes
            /// filled with zero.
            /// </summary>
            public byte* buf;
        ...
        public unsafe partial struct AVOutputFormat
        {
            ...
            /// </summary>
            public global::System.IntPtr deinit;
            ...
            /// </summary>
            public global::System.IntPtr check_bitstream;
        }
        ...
        public unsafe partial struct AVIndexEntry
        {
            ...
            /// <summary>
            /// &lt; Minimum distance between this and the previous keyframe, used to
            /// avoid unneeded searching.
            /// </summary>
        ...
        public unsafe partial struct AVStream
        {
            ...
            /// <summary>
            /// If not 0, the number of samples that should be skipped from the start
            /// of
            /// the stream (the samples are removed from packets with pts==0, which
            /// also
            ...
            public libavformat.FFFrac* priv_pts;

            /// <summary>
            /// An opaque field for libavformat internal usage.
            /// Must not be accessed in any way by callers.
            /// </summary>
            public libavformat.AVStreamInternal* @internal;

            public libavcodec.AVCodecParameters* codecpar;
            ...
            public unsafe partial struct AVStream_anon
            {
                ...
                public fixed fixed double duration_error[798];
        ...
        /// the name string used matches the associated command line parameter name
        /// and
        ...
        public unsafe partial struct AVFormatContext
        {
            ...
            /// The function should behave like avio_open2(), AVFormatContext is
            /// provided
            ...
            /// </summary>
            [System.ObsoleteAttribute()]
            public global::System.IntPtr open_cb;
            ...
            public global::System.IntPtr io_open;

            /// <summary>
            /// A callback for closing the streams opened with
            /// AVFormatContext.io_open().
            /// </summary>
            public global::System.IntPtr io_close;
        ...
        [DllImport(AVFORMAT_DLL_NAME, CallingConvention = global::System.Runtime.InteropServices.CallingConvention.Cdecl,
            CharSet = CharSet.Ansi, ExactSpelling = true,
            EntryPoint="av_format_get_open_cb")]
        public static extern global::System.IntPtr av_format_get_open_cb(libavformat.AVFormatContext* s);

        [System.ObsoleteAttribute()]
        [SuppressUnmanagedCodeSecurity]
        [DllImport(AVFORMAT_DLL_NAME, CallingConvention = global::System.Runtime.InteropServices.CallingConvention.Cdecl,
            CharSet = CharSet.Ansi, ExactSpelling = true,
            EntryPoint="av_format_set_open_cb")]
        public static extern void av_format_set_open_cb(libavformat.AVFormatContext* s, global::System.IntPtr callback);
        ...
        [DllImport(AVFORMAT_DLL_NAME, CallingConvention = global::System.Runtime.InteropServices.CallingConvention.Cdecl,
            CharSet = CharSet.Ansi, ExactSpelling = true,
            EntryPoint="av_stream_new_side_data")]
        public static extern byte* av_stream_new_side_data(libavformat.AVStream* stream, libavcodec.AVPacketSideDataType type, int size);
        ...
        public static extern int av_probe_input_buffer2(libavformat.AVIOContext* pb, libavformat.AVInputFormat** fmt, string url, void* logctx, uint offset, uint max_probe_size);
        ...
        [DllImport(AVFORMAT_DLL_NAME, CallingConvention = global::System.Runtime.InteropServices.CallingConvention.Cdecl,
            CharSet = CharSet.Ansi, ExactSpelling = true,
            EntryPoint="av_probe_input_buffer2")]
        public static extern int av_probe_input_buffer2(libavformat.AVIOContext* pb, ref libavformat.AVInputFormat* fmt, string url, void* logctx, uint offset, uint max_probe_size);
        ...
        public static extern int av_probe_input_buffer(libavformat.AVIOContext* pb, libavformat.AVInputFormat** fmt, string url, void* logctx, uint offset, uint max_probe_size);
        ...
        [DllImport(AVFORMAT_DLL_NAME, CallingConvention = global::System.Runtime.InteropServices.CallingConvention.Cdecl,
            CharSet = CharSet.Ansi, ExactSpelling = true,
            EntryPoint="av_probe_input_buffer")]
        public static extern int av_probe_input_buffer(libavformat.AVIOContext* pb, ref libavformat.AVInputFormat* fmt, string url, void* logctx, uint offset, uint max_probe_size);
        ...
        public static extern int avformat_open_input(libavformat.AVFormatContext** ps, string url, libavformat.AVInputFormat* fmt, libavutil.AVDictionary** options);
        ...
        [DllImport(AVFORMAT_DLL_NAME, CallingConvention = global::System.Runtime.InteropServices.CallingConvention.Cdecl,
            CharSet = CharSet.Ansi, ExactSpelling = true,
            EntryPoint="avformat_open_input")]
        public static extern int avformat_open_input(ref libavformat.AVFormatContext* ps, string url, libavformat.AVInputFormat* fmt, ref libavutil.AVDictionary* options);
        ...
        [DllImport(AVFORMAT_DLL_NAME, CallingConvention = global::System.Runtime.InteropServices.CallingConvention.Cdecl,
            CharSet = CharSet.Ansi, ExactSpelling = true,
            EntryPoint="av_program_add_stream_index")]
        public static extern void av_program_add_stream_index(libavformat.AVFormatContext* ac, int progid, uint idx);
        ...
        /// av_packet_unref when it is no longer needed. For video, the packet
        /// contains
        ...
        /// Write an uncoded frame to an output media file.
        /// 
        /// If the muxer supports it, this function makes it possible to write an
        /// AVFrame
        ...
        [DllImport(AVFORMAT_DLL_NAME, CallingConvention = global::System.Runtime.InteropServices.CallingConvention.Cdecl,
            CharSet = CharSet.Ansi, ExactSpelling = true,
            EntryPoint="av_apply_bitstream_filters")]
        public static extern int av_apply_bitstream_filters(libavcodec.AVCodecContext* codec, libavcodec.AVPacket* pkt, libavcodec.AVBitStreamFilterContext* bsfc);
    }
}
