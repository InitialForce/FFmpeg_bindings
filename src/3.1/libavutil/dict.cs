...
namespace FFmpeg
{
    ...
    public unsafe static partial class libavutil
    {
        ...
        public const sbyte AV_DICT_MULTIKEY = 64;
        ...
        /// </param>
        /// <param name="key">
        /// entry key to add to *pm (will either be av_strduped or added as a new
        /// key depending on flags)
        /// </param>
        /// <param name="value">
        /// entry value to add to *pm (will be av_strduped or added as a new key
        /// depending on flags).
        ...
        /// </remark>
        /// <returns>
        /// 0 on success, negative AVERROR code on failure. If dst was allocated
        ...
        public static extern int av_dict_copy(libavutil.AVDictionary** dst, libavutil.AVDictionary* src, int flags);
        ...
        [DllImport(AVUTIL_DLL_NAME, CallingConvention = global::System.Runtime.InteropServices.CallingConvention.Cdecl,
            CharSet = CharSet.Ansi, ExactSpelling = true,
            EntryPoint="av_dict_copy")]
        public static extern int av_dict_copy(ref libavutil.AVDictionary* dst, libavutil.AVDictionary* src, int flags);
