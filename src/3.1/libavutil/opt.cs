...
namespace FFmpeg
{
    ...
    public unsafe static partial class libavutil
    {
        ...
        public const ulong AV_OPT_SEARCH_CHILDREN = (1 << 0);

        public const ulong AV_OPT_SEARCH_FAKE_OBJ = (1 << 1);

        public const ulong AV_OPT_ALLOW_NULL = (1 << 2);

        public const ulong AV_OPT_MULTI_COMPONENT_RANGE = (1 << 12);

        public const sbyte AV_OPT_SERIALIZE_SKIP_DEFAULTS = 0x1;

        public const sbyte AV_OPT_SERIALIZE_OPT_FLAGS_EXACT = 0x2;
        ...
        /// dictionary
        /// filled with option as a parameter. This makes it possible to set some
        /// options
        ...
        public unsafe partial struct AVOptionRanges
        {
            ...
            /// for (range_index = 0; range_index &lt; ranges-&gt;nb_ranges;
            /// range_index++) {
            /// for (component_index = 0; component_index &lt;
            /// ranges-&gt;nb_components; component_index++)
            /// range[component_index] = ranges-&gt;range[ranges-&gt;nb_ranges *
        ...
        /// <summary>
        /// Set the values of all AVOption fields to their default values. Only
        /// these
        /// AVOption fields for which (opt-&gt;flags & mask) == flags will have
        /// their
        ...
        [DllImport(AVUTIL_DLL_NAME, CallingConvention = global::System.Runtime.InteropServices.CallingConvention.Cdecl,
            CharSet = CharSet.Ansi, ExactSpelling = true,
            EntryPoint="av_opt_set_dict2")]
        public static extern int av_opt_set_dict2(void* obj, libavutil.AVDictionary** options, int search_flags);
        ...
        [DllImport(AVUTIL_DLL_NAME, CallingConvention = global::System.Runtime.InteropServices.CallingConvention.Cdecl,
            CharSet = CharSet.Ansi, ExactSpelling = true,
            EntryPoint="av_opt_set_dict2")]
        public static extern int av_opt_set_dict2(void* obj, ref libavutil.AVDictionary* options, int search_flags);
        ...
        [DllImport(AVUTIL_DLL_NAME, CallingConvention = global::System.Runtime.InteropServices.CallingConvention.Cdecl,
            CharSet = CharSet.Ansi, ExactSpelling = true,
            EntryPoint="av_opt_set_dict_val")]
        public static extern int av_opt_set_dict_val(void* obj, string name, libavutil.AVDictionary* val, int search_flags);
        ...
        /// </remark>
        /// <remark>
        /// if AV_OPT_ALLOW_NULL is set in search_flags in av_opt_get, and the
        /// option has
        /// AV_OPT_TYPE_STRING or AV_OPT_TYPE_BINARY and is set to NULL, *out_val
        /// will be set
        ...
        [DllImport(AVUTIL_DLL_NAME, CallingConvention = global::System.Runtime.InteropServices.CallingConvention.Cdecl,
            CharSet = CharSet.Ansi, ExactSpelling = true,
            EntryPoint="av_opt_get_dict_val")]
        public static extern int av_opt_get_dict_val(void* obj, string name, int search_flags, libavutil.AVDictionary** out_val);

        [SuppressUnmanagedCodeSecurity]
        [DllImport(AVUTIL_DLL_NAME, CallingConvention = global::System.Runtime.InteropServices.CallingConvention.Cdecl,
            CharSet = CharSet.Ansi, ExactSpelling = true,
            EntryPoint="av_opt_get_dict_val")]
        public static extern int av_opt_get_dict_val(void* obj, string name, int search_flags, ref libavutil.AVDictionary* out_val);
        ...
        /// AV_OPT_MULTI_COMPONENT_RANGE indicates that function may return more
        /// than one component, @see AVOptionRanges
        /// 
        /// The result must be freed with av_opt_freep_ranges.
        /// </param>
        /// <returns>
        /// number of compontents returned on success, a negative errro code
        /// otherwise
        /// </returns>
        [SuppressUnmanagedCodeSecurity]
        [DllImport(AVUTIL_DLL_NAME, CallingConvention = global::System.Runtime.InteropServices.CallingConvention.Cdecl,
        ...
        /// 
        /// Options o must belong to the obj. This function must not be called to
        /// check child's options state.
        ...
        /// </param>
        /// <returns>
        /// &gt;0 when option is set to its default,
        ...
        [DllImport(AVUTIL_DLL_NAME, CallingConvention = global::System.Runtime.InteropServices.CallingConvention.Cdecl,
            CharSet = CharSet.Ansi, ExactSpelling = true,
            EntryPoint="av_opt_is_set_to_default")]
        public static extern int av_opt_is_set_to_default(void* obj, libavutil.AVOption* o);
        ...
        [DllImport(AVUTIL_DLL_NAME, CallingConvention = global::System.Runtime.InteropServices.CallingConvention.Cdecl,
            CharSet = CharSet.Ansi, ExactSpelling = true,
            EntryPoint="av_opt_is_set_to_default_by_name")]
        ...
        /// </summary>
        /// <param name="[in]">
        /// obj           AVClass object to serialize
        /// </param>
        /// <param name="[in]">
        /// opt_flags     serialize options with all the specified flags set
        /// (AV_OPT_FLAG)
        /// </param>
        /// <param name="[in]">
        /// flags         combination of AV_OPT_SERIALIZE_* flags
        /// </param>
        /// <param name="[out]">
        /// buffer        Pointer to buffer that will be allocated with string
        /// containg serialized options.
        ...
        [DllImport(AVUTIL_DLL_NAME, CallingConvention = global::System.Runtime.InteropServices.CallingConvention.Cdecl,
            CharSet = CharSet.Ansi, ExactSpelling = true,
            EntryPoint="av_opt_serialize")]
        public static extern int av_opt_serialize(void* obj, int opt_flags, int flags, ref System.Text.StringBuilder buffer, sbyte key_val_sep, sbyte pairs_sep);
    }
}
