...
namespace FFmpeg
{
    ...
    public unsafe static partial class libswscale
    {
        ...
        public const sbyte SWS_POINT = 0x10;

        public const sbyte SWS_AREA = 0x20;

        public const sbyte SWS_BICUBLIN = 0x40;

        public const byte SWS_GAUSS = 0x80;

        public const short SWS_SINC = 0x100;

        public const short SWS_LANCZOS = 0x200;

        public const short SWS_SPLINE = 0x400;
        ...
        public const short SWS_PRINT_INFO = 0x1000;

        public const short SWS_FULL_CHR_H_INT = 0x2000;

        public const short SWS_FULL_CHR_H_INP = 0x4000;

        public const ushort SWS_DIRECT_BGR = 0x8000;
        ...
        public const sbyte SWS_CS_BT2020 = 9;
        ...
        /// </param>
        /// <param name="param">
        /// extra parameters to tune the used scaler
